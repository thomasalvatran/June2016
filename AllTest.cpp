...
class Base 
{
	public:
		...
		virtual ~Base() { cout << "Base Dctor" << endl; } //virtual Ctors will called Derived DTOR
};
...
{
	cout << *val << endl;
	*val = "test4";  //reference && rvalue you can now change val
}
...
int main(int argc, char const *argv[])
{
	...
	cout << "s = " << s << endl;
	myfunc3(&s);					// OK &address to pointer
	( *myfunc3 )(&s);				//function pointer can call any function with pointer
...
public:
	int data;
	// BstNode operator*() { }//return BstNode; 
};

BstNode root;
void duplicate (BstNode &root)
{
	// a *= 2; //change A like value
	// b *= 2; // not pointer
	// c *= 2;
...
void duplicate1(BstNode *root)
{
	root->data = 1111;
}
BstNode* duplicate2(BstNode *root)
{
	BstNode *temp = root;
	temp->data = 2222;
	return root;
}
BstNode duplicate3(BstNode root)
{
	// BstNode *temp = (BstNode*)(root);  //cannot convert ‘BstNode’ to ‘BstNode*’ in initialization
	// temp->data = 2222;
	BstNode temp = root;
	root.data = 3333;
	return root;
...
void print(int& i)
{
	...
	cout << "print & lvalue ref = " << i << endl;
}
void print(int &&i)  //same as int i
{
	cout << "print && rvalue ref = " << i << endl;
}
void printVal(int i)  //same
{
	cout << "printVal = " << i << endl;
...
int main ()
{
	...
	duplicate1(&root);				//pass by reference no need to return myschoolcode 
	cout << root.data << endl;

	// BstNode *test0 = duplicate2(&root); no need to return
	// cout << test0->data << endl;
	duplicate2(&root); //lvalue ref myschoolcode on tree
	cout << root.data << endl;

	BstNode test = duplicate3(root);   //value need to return 
	cout << test.data << endl;
